package app.client.net.protocol.request.sdk.single.home;
...
@Protocol(moduleId = SdkMsgType.XB_CLIENT_TYPE, sequenceId = Device2TcpProtocol.SDK_UPDATE_HOME_C, type = ProtocolType.REQUSET)
public class C_UPDATE_HOME extends RequestProtocol{
