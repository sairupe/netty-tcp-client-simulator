package app.client.net.protocol.response.sdk.batch.scene;
...
@Protocol(moduleId = SdkMsgType.XB_CLIENT_TYPE, sequenceId = Tcp2DeviceProtocol.SDK_ADD_SCENE_BATCH_RESULT_S, type = ProtocolType.RESPONSE)
public class S_ADD_SCENE_BATCH extends ResponseProtocol{
