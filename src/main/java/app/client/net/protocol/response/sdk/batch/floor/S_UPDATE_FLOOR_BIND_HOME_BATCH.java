package app.client.net.protocol.response.sdk.batch.floor;
...
@Protocol(moduleId = SdkMsgType.XB_CLIENT_TYPE, sequenceId = Tcp2DeviceProtocol.SDK_UPDATE_FLOOR_BIND_HOME_BATCH_RESULT_S, type = ProtocolType.RESPONSE)
public class S_UPDATE_FLOOR_BIND_HOME_BATCH extends ResponseProtocol{
