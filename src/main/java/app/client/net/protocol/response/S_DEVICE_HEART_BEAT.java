...
public class S_DEVICE_HEART_BEAT extends ResponseProtocol{
    ...
    SdkDeviceBothMsg.SdkDeviceHeartBeatMsg heartBeatMsg;

    @Override
    public boolean readBinaryData(){
        try {
            heartBeatMsg = SdkDeviceBothMsg.SdkDeviceHeartBeatMsg.parseFrom(buffer.array());
    ...
    public SdkDeviceBothMsg.SdkDeviceHeartBeatMsg getHeartBeatMsg() {
        return heartBeatMsg;
    }
}
