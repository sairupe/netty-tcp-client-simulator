package app.client.net.protocol.response.sdk.area;
...
@Protocol(moduleId = SdkMsgType.SDK_DEVICE_CLIENT_TYPE, sequenceId = SdkTcp2DeviceProtocol.SDK_UPDATE_AREA_BIND_FLOOR_RESULT_S, type = ProtocolType.RESPONSE)
public class S_UPDATE_AREA_BIND_FLOOR extends ResponseProtocol{
