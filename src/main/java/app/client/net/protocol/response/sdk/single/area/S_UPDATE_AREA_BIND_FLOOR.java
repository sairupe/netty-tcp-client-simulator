package app.client.net.protocol.response.sdk.single.area;
...
@Protocol(moduleId = SdkMsgType.XB_CLIENT_TYPE, sequenceId = Tcp2DeviceProtocol.SDK_UPDATE_AREA_BIND_FLOOR_RESULT_S, type = ProtocolType.RESPONSE)
