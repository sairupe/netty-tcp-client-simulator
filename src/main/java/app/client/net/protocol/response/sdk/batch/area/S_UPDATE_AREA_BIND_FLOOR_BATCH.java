package app.client.net.protocol.response.sdk.batch.area;
...
@Protocol(moduleId = SdkMsgType.XB_CLIENT_TYPE, sequenceId = Tcp2DeviceProtocol.SDK_UPDATE_AREA_BIND_FLOOR_BATCH_RESULT_S, type = ProtocolType.RESPONSE)
public class S_UPDATE_AREA_BIND_FLOOR_BATCH extends ResponseProtocol{
